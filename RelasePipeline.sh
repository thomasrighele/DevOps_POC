...
echo "curl -k -u $artifactory_username:$artifactory_password --remote-name https://artifactory.nasa.azu.mrshmc.com/artifactory/gciics/$BuildRepositoryName/$BuildRepositoryName_$BuildBuildNumber.zip -o $SystemArtifactsDirectory"
