...
echo "This is test 1 $BuildRepositoryName/$BuildRepositoryName_$BuildBuildNumber.zip"
echo "This is test 2 "$BuildRepositoryName"/"$BuildRepositoryName"_$BuildBuildNumber.zip"
