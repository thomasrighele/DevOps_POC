...
"$7/GC%20Integration/IICS Asset Management Utility/iics_linux" import --name "AzureDevops_Release-$8" --password "$9" --podHostName "dm-us.informaticacloud.com" --region "us" --username "$10" --zipFilePath "$4/Package_$3.zip"
